  ...
  <div style="padding: 5px 20px;">
    ...
    <el-form :inline="true" :model="listQuery" class="demo-form-inline">
      <el-form-item label="组织名称">
        <el-input v-model="listQuery.unit_name" placeholder="组织名称"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table :data="list" element-loading-text="Loading" border fit highlight-current-row>
      ...
      <el-table-column label="组织ID" prop="unit_account">
      </el-table-column>
      <el-table-column label="组织名称" prop="unit_name">
      </el-table-column>
      <el-table-column label="描述" prop="unit_description">
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="collectionform" :rules="rules" :model="ruleForm" label-width="120px" label-position="left">
        <el-form-item label="组织ID" prop="unit_account" v-if="dialogStatus=='create'">
          <el-input placeholder="组织ID" v-model="ruleForm.unit_account"></el-input>
        </el-form-item>
        <el-form-item label="组织名称" prop="unit_name" v-if="dialogStatus=='create'">
          <el-input placeholder="组织名称" v-model="ruleForm.unit_name"></el-input>
        </el-form-item>
        <el-form-item label="描述" prop="unit_description" v-if="dialogStatus=='create'">
          <el-input placeholder="描述" v-model="ruleForm.unit_description"></el-input>
        </el-form-item>
        <el-form-item label="企业ID" prop="unit_enterpriseID">
